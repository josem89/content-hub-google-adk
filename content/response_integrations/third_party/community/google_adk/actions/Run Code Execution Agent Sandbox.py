...
def main():
    ...
    try:
        ...
        agent_engine_resource = siemplify.extract_action_param(
...
Provide technical reasoning for your approach."""
        ...
        siemplify.LOGGER.info(
            f"Launching Code Execution Agent: {agent_name} for Case: {siemplify.case_id} (Memory: {enable_memory}, Session: {session_id})"
        )
